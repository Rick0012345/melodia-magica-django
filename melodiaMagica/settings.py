...
ACCOUNT_EMAIL_REQUIRED = False  # Email não obrigatório
...
SOCIALACCOUNT_EMAIL_REQUIRED = False  # Email não obrigatório para login social
SOCIALACCOUNT_EMAIL_VERIFICATION = 'none'  # Sem verificação de email para login social
